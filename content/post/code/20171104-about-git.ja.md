...
canonical: false
---
こちらの説明はLinus TorvaldsによってGITソースコードを公開した時の解説である。実は<a href="https://github.com/git/git/tree/e83c5163316f89bfbde7d9ab23ca2e25604af290" target="_blank" rel="noopener noreferrer">Github</a>から引用したものです。
<!--more-->
