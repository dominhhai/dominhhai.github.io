...
Để tính đạo hàm của hàm lỗi $\nabla J(\mathbb{W})$ trong mạng NN, ta sử dụng một giải thuật đặc biệt là giải thuật **lan truyền ngược** (*backpropagation*).

Về cơ bản phương pháp này được dựa theo [quy tắc chuỗi đạo hàm của hàm hợp](/vi/2017/10/multi-var-func/#5-%C4%91%E1%BA%A1o-h%C3%A0m-ri%C3%AAng-c%E1%BB%A7a-h%C3%A0m-h%E1%BB%A3p) bởi để tính được $J(\mathbb{W})$ ta cũng phải trải qua quá trình lan truyền tiến từ tầng vào tới tầng ra với sự kết hợp liên hàm của nhiều hàm số.

> Trong bài này, tôi chỉ đề cập ngay tới công thức tính toán còn việc chứng minh thì tôi sẽ dành cho các bài tiếp theo.
