...
Đằng sau sự thành côn này chính là sự đóng góp của
...
LSTM cũng có kiến trúc dạng cuỗi như vậy, nhưng các mô-đun trong nó có cấu trúc khác với mạng RNN chuẩn.
...
thông tin về giới của một nhân vật nào đó giúp ta sử dụng được đại từ nhân xưng chuẩn xác.
...
Giờ là lúc cập nhập trạng thái tế bào cũ $ C{t-1} $ thành trạng thái mới $ C_t $.
