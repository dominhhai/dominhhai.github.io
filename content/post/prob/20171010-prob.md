...
$$ P\Bigg(\sum\_{i=1}^n{A_i}\Bigg) = \sum\_{i=1}^n (-1)^{i-1} \sum\_{k_1 \le \cdots \le k_i} P\Big(\prod\_{j=1}^nA\_{k_j}\Big) $$
...
* $\displaystyle P\Bigg(\sum\_{i=1}^n{A_i|B}\Bigg) = \sum\_{i=1}^n (-1)^{i-1} \sum\_{k_1 \le \cdots \le k_i} P\Big(\prod\_{j=1}^nA\_{k_j}|B\Big) $
