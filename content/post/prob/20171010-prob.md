...
* **Sự kiện xung khắc**: Là các sự kiện không đồng thời xảy ra. Các sự kiện $\\{A_i\\},i=\overline{1,n}$ xung khắc đôi một khi và chỉ khi $\displaystyle\bigcup\_{i=1}^n{A_i}=\emptyset$.
